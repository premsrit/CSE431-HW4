...
# Red-black Tree Implementation from https://github.com/emilydolson/python-red-black-trees given by instructor
import sys
...
class RedBlackTree():
    ...
    def __getitem__(self, key):
        ...
        if search_node is self.TNULL:
            raise KeyError('No Exist Key')
    ...
    def __contains__(self, item):
        return self.search(item) is not self.TNULL
